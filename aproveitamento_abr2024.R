# Aproveitamento das equipes da série C no mês de Abril de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_abr24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_abr24
...
aproveitamento_times_seriec_abr24$time <- factor(aproveitamento_times_seriec_abr24$time, 
                                                 levels = unique(aproveitamento_times_seriec_abr24$time))
...
aproveitamento_times_seriec_abr24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Abril 2024",
       x = "Times",
       y = "Aproveitamento")
...
jogos_disputados_abr24 <- times_serieC2024_geral %>%
