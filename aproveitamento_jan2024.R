# Aproveitamento das equipes da série C no mês de Janeiro de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_jan24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_jan24
...
aproveitamento_times_seriec_jan24$time <- factor(aproveitamento_times_seriec_jan24$time, 
                                                 levels = unique(aproveitamento_times_seriec_jan24$time))
...
aproveitamento_times_seriec_jan24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Janeiro 2024",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em Janeiro 2024:

jogos_disputados_jan24 <- times_serieC2024_geral %>%
