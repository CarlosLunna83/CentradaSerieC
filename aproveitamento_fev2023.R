# Aproveitamento das equipes da série C no mês de fevereiro de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_fev23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_fev23
...
aproveitamento_times_seriec_fev23$time <- factor(aproveitamento_times_seriec_fev23$time, 
                                                 levels = unique(aproveitamento_times_seriec_fev23$time))
...
aproveitamento_times_seriec_fev23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Fevereiro 2023",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em fevereiro 2023:

jogos_disputados_fev23 <- times_serieC2023_geral %>%
