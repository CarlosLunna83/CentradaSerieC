# Aproveitamento das equipes da série C no mês de março de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_mar23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_mar23
...
aproveitamento_times_seriec_mar23$time <- factor(aproveitamento_times_seriec_mar23$time, 
                                                 levels = unique(aproveitamento_times_seriec_mar23$time))
...
aproveitamento_times_seriec_mar23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Marco 2023",
       x = "Times",
       y = "Aproveitamento")
