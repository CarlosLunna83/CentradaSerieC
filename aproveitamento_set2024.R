# Aproveitamento das equipes da série C no mês de Setembro de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_set24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_set24
...
aproveitamento_times_seriec_set24$time <- factor(aproveitamento_times_seriec_set24$time, 
                                                 levels = unique(aproveitamento_times_seriec_set24$time))
...
aproveitamento_times_seriec_set24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Setembro 2024",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em Setembro 2024:

jogos_disputados_set24 <- times_serieC2024_geral %>%
