# Aproveitamento das equipes da série C no ano de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_2024
...
aproveitamento_times_seriec_2024$time <- factor(aproveitamento_times_seriec_2024$time, 
                                                 levels = unique(aproveitamento_times_seriec_2024$time))
