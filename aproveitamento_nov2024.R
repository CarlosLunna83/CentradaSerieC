# Aproveitamento das equipes da série C no mês de Novembro de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_nov24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_nov24
...
aproveitamento_times_seriec_nov24$time <- factor(aproveitamento_times_seriec_nov24$time, 
                                                 levels = unique(aproveitamento_times_seriec_nov24$time))
...
aproveitamento_times_seriec_nov24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Novembro 2024",
       x = "Times",
       y = "Aproveitamento")
...
jogos_disputados_nov24 <- times_serieC2024_geral %>%
