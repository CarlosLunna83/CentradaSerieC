# Aproveitamento das equipes da série C no mês de Julho de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_jul23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_jul23
...
aproveitamento_times_seriec_jul23$time <- factor(aproveitamento_times_seriec_jul23$time, 
                                                 levels = unique(aproveitamento_times_seriec_jul23$time))
...
aproveitamento_times_seriec_jul23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Julho 2023",
       x = "Times",
       y = "Aproveitamento")
...
jogos_disputados_jul23 <- times_serieC2023_geral %>%
