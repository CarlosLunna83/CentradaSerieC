# Aproveitamento das equipes da série C no mês de Outubro de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_out23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_out23
...
aproveitamento_times_seriec_out23$time <- factor(aproveitamento_times_seriec_jul23$time, 
                                                 levels = unique(aproveitamento_times_seriec_out23$time))
...
aproveitamento_times_seriec_out23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Outubro 2023",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em Julho 2023:

jogos_disputados_out23 <- times_serieC2023_geral %>%
