# Aproveitamento das equipes da série C no mês de Maio de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_mai23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_mai23
...
aproveitamento_times_seriec_abr23$time <- factor(aproveitamento_times_seriec_mai23$time, 
                                                 levels = unique(aproveitamento_times_seriec_mai23$time))
...
aproveitamento_times_seriec_mai23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Maio 2023",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em Maio 2023:

jogos_disputados_mai23 <- times_serieC2023_geral %>%
