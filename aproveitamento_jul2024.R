# Aproveitamento das equipes da série C no mês de Julho de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_jul24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_jul24
...
aproveitamento_times_seriec_jul24$time <- factor(aproveitamento_times_seriec_jul24$time, 
                                                 levels = unique(aproveitamento_times_seriec_jul24$time))
...
aproveitamento_times_seriec_jul24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Julho 2024",
       x = "Times",
       y = "Aproveitamento")
...
jogos_disputados_jul24 <- times_serieC2024_geral %>%
