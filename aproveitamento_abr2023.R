# Aproveitamento das equipes da série C no mês de Abril de 2023 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_abr23 <- times_serieC2023_geral %>%
...
aproveitamento_times_seriec_abr23
...
aproveitamento_times_seriec_abr23$time <- factor(aproveitamento_times_seriec_abr23$time, 
                                                 levels = unique(aproveitamento_times_seriec_abr23$time))
...
aproveitamento_times_seriec_abr23 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Abril 2023",
       x = "Times",
       y = "Aproveitamento")


# Jogos disputados por cada equipe em Abril 2023:

jogos_disputados_abr23 <- times_serieC2023_geral %>%
