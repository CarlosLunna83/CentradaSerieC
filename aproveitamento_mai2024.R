# Aproveitamento das equipes da série C no mês de Maio de 2024 (considerando só jogos oficiais)
...
aproveitamento_times_seriec_mai24 <- times_serieC2024_geral %>%
...
aproveitamento_times_seriec_mai24
...
aproveitamento_times_seriec_mai24$time <- factor(aproveitamento_times_seriec_mai24$time, 
                                                 levels = unique(aproveitamento_times_seriec_mai24$time))
...
aproveitamento_times_seriec_mai24 %>%
  ...
  labs(title = "Aproveitamento times da Série C em Maio 2024",
       x = "Times",
       y = "Aproveitamento")
...
jogos_disputados_mai24 <- times_serieC2024_geral %>%
